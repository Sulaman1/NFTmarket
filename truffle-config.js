...
module.exports = {
  ...
  networks: {
    ...
    mumbai: {
      provider: () => new HDWalletProvider(priKey, `https://polygon-mumbai.infura.io/v3/33b80616d03249baa458695ca6f348b4`),
  ...
  contracts_build_directory: './pages/build/contracts/',
